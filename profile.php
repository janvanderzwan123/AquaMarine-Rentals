        ...
        <?php if (!empty($advertisements)): ?>
            <?php foreach ($advertisements as $advertisement): ?>
                <div id="profiel-advertentie" class="col-md-4">
                    <a href="verhuurder_detail_pagina.php?advertentie_id=<?php echo $advertisement['advertentie_id']; ?>" style="text-decoration: none;" class="card mb-4 profiel-advertentie">
                        <div class="card-body">
